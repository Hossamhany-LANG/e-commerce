                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    <a href="{{route('admin.main_categories.index')}}">Main Categories</a></div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{App\Models\Main_category::where('translation_of' ,0)->count()}}</div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    <a href="{{route('admin.products.index')}}">Products</a></div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    <a href="{{route('showorders')}}">Orders</a></div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            ...
                            @foreach($pieLabels as $index => $label)
                                <span class="mr-2">
                                    <i class="fas fa-circle {{ $colors[$index] ?? 'text-secondary' }}"></i> {{ $label }}
                                </span>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        @foreach($categoryStats as $stat)
                            <h4 class="small font-weight-bold">
                                {{ $stat['name'] }} 
                                <span class="float-right">{{ round($stat['percentage']) }}%</span>
                            </h4>
...
@section('script')
    ...
    <script>
        ...
        var labels = monthsData.map(m => monthNames[m - 1]);
