...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Add a new language</h6>
            <div class="ml-auto">
            ...
            <form action="{{route('admin.languages.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="Enter Language Name...">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input id="abbr" type="text" name="abbr" value="{{old('name')}}" class="form-control" placeholder="Enter Language Abbreviation...">
                ...
                <div class="col-3">
                    ...
                    <select name="direction" class="form-control">
                            <option value="" selected disabled>choose the language direction</option>
                            <option value="rtl">from right to left</option>
                            <option value="ltr">from lift to right</option>    
                    </select>
