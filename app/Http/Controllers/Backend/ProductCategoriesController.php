...
class ProductCategoriesController extends Controller
{
    ...
    {
        // if (Auth::user()->role !== 'admin' || !Auth::user()->hasPermissionTo('manage_product_categories','show_product_categories')) {
    ...
    {
        // if (Auth::user()->role !== 'admin' || !Auth::user()->hasPermissionTo('create_product_categories')) {
        //     return redirect('admin/index');
        // }
    ...
    {
        // if (Auth::user()->role !== 'admin' || !Auth::user()->hasPermissionTo('display_product_categories')) {
        //     return redirect('admin/index');
        // }
    ...
    {
        // if (Auth::user()->role !== 'admin' || !Auth::user()->hasPermissionTo('update_product_categories')) {
        //     return redirect('admin/index');
        // }
        $main_categories = ProductCategory::whereNull('parent_id')->get(['id' , 'name']);
    ...
    {
        // if (Auth::user()->role !== 'admin' || !Auth::user()->hasPermissionTo('delete_product_categories')) {
        //     return redirect('admin/index');
        // }
